...
public class SignInActivity extends AppCompatActivity
{
    ...
    /**
     * Tutorial Carousel view. Images are provided for the carousel in the array.
     */
    private CarouselView carouselView;
    int[] carouselImages = {R.mipmap.splash_icon, R.mipmap.icon_home, R.mipmap.user};
    ...
    private class SignInResultsHandler implements IdentityManager.SignInResultsHandler
    {
        ...
        {
            Log.d(LOG_TAG, String.format("User sign-in with %s succeeded", provider.getDisplayName()));
            // The sign-in manager is no longer needed once signed in.
            SignInManager.dispose();

            Toast.makeText(SignInActivity.this, String.format("Sign-in with %s succeeded.", provider.getDisplayName()), Toast.LENGTH_LONG).show();
        ...
        {
            Log.d(LOG_TAG, String.format("User sign-in with %s canceled.", provider.getDisplayName()));

            Toast.makeText(SignInActivity.this, String.format("Sign-in with %s canceled.", provider.getDisplayName()), Toast.LENGTH_LONG).show();
        }
        ...
        {
            Log.e(LOG_TAG, String.format("User Sign-in failed for %s : %s", provider.getDisplayName(), ex.getMessage()), ex);
            ...
            errorDialogBuilder.setMessage(String.format("Sign-in with %s failed.\n%s", provider.getDisplayName(), ex.getMessage()));
    ...
    protected void onCreate(final Bundle savedInstanceState)
    {
        ...
        // Setting the carousel and adding images
